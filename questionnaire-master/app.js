...
//路径
app.get('/answerList/:questionnaire',Admin.loginRequired, Answer.listPage);
app.get('/data/allQuestions',Admin.loginRequired,Question.allDetail);
app.get('/data/allOptions',Admin.loginRequired,Option.allDetail);
app.get('/data/answer/:questionnaire',Admin.loginRequired,Answer.detail);
app.delete('/data/answer/:answer',Admin.loginRequired,Answer.delete)
