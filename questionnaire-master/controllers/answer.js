...
exports.listPage =function(req ,res){
    res.sendFile(path.join(__dirname,'../view/manage/answerList.html'));
};

//根据id或ids批量删除
exports.delete=function(req,res){
    var answerId=req.params.answer;
    var ids=answerId.split(",");
    //批量删除
    Answer.remove({'_id':{$in:ids}},function (err,answer) {
        if(err){
            return res.json({
                success:false,
                error:err.message
